...
#10dita per NVDA
Questo add-on permette di utilizzare il software 10dita con NVDA. In particolare, il software rende accessibili all'utente mediante lo screen reader open source tutte le principali videate ed esercizi disponibili per 10dita nella sua ultima versione, la 3.0.
